	...
	<div class="col-md-9">
		...
		<h2>
			...
			<button type="button" class="btn btn-primary " data-toggle="modal"
				data-target="#myModal">Registrar Gasto</button>
		</h2>
			...
			<tbody>
				<c:forEach var="gastos" items="${gastoslist}" varStatus="status">
					<tr>
						...
						<td><fmt:formatDate value="${gastos.fechaEmision}"
								pattern="dd-MM-yyyy" /></td>
						<td><fmt:formatDate value="${gastos.fechaPago}"
								pattern="dd-MM-yyyy" /></td>
						<td>${gastos.estado}</td>
						...
						<td><a href='<c:out value="${gastoUrl2}"/>'
							data-original-title="Editar gasto" data-toggle="tooltip"
		...
		<div class="col-sm-12">
			<div>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="row">
									<h4>¿Está seguro de que desea eliminar este gasto?</h4>
								</div>

								<div class="modal-footer">
									<button type="button" class="btn btn-default"
										data-dismiss="modal">Cancelar</button>
									<a href='<c:out value="${gastoUrl}"/>'type="button" class="btn btn-danger">Eliminar </a>
								</div>
							</div>
						</div>
					</div>
				...
				<!-- Modal -->
				<form:form action="addGasto" method="POST" modelAttribute="newGasto"
								...
								<div class="modal-body">
									<div class="row">
										...
										<div class="col-xs-3">
											...
											<form:input class="form-control" path="fechaEmision"
												type="date" />
										</div>
