	...
	<div class="col-md-9">
		...
		<h2>
			...
			<button type="button" class="btn btn-primary " data-toggle="modal"
				data-target="#myModal">Registrar Centro</button>
		</h2>
						...
						<td>
							<div class="dropdown">
								...
								<ul class="dropdown-menu" aria-labelledby="dLabel">
									...
									<li><a href='<c:out value="${centroUrl2}"/>'>Añadir
											empleado</a></li>
									<li><a href='' data-toggle="modal"
										data-target="#deleteModal">Eliminar </a></li>
								</ul>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="modal-footer">
							...
							<a href='<c:out value="${centroUrl}"/>' type="button"
		...
		<form:form action="addCentro" method="POST" modelAttribute="myCentro"
